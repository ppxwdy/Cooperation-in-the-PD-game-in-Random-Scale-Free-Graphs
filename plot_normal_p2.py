...
ax[0].set_title('The time evolution of the fraction of cooperators c(t) in Random SF when k = 2')
ax[1].set_title('The time evolution of the fraction of cooperators c(t) in Random SF when k = 3')
...
# plt.savefig('normal_pic_part2_vertical.png')
